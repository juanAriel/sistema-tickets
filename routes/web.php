...
// Route::post('/panel/{type}/next', [TicketController::class, 'nextTicket'])->name('panel.next');
Route::post('/panel/{type}/next/{ticket?}', [TicketController::class, 'nextTicket'])->name('panel.next');
